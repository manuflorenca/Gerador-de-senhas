...
const lengthInput = document.querySelector("#length"); // Corrigido de "lenght" para "length"
...
const getSymbol = () => {
    const symbols = "(){}[]=<>/,.!@#$%&*+-";
    return symbols[Math.floor(Math.random() * symbols.length)]; // Corrigido de "lenght" para "length"
};

const generatePassword = (getLetterLowerCase, getLetterUpperCase, getNumber, getSymbol) => {
    let password = "";

    const passwordLength = parseInt(lengthInput.value); // Certifique-se de que seja um número
